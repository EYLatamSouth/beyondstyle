      ...
      <AppBar position="relative" color="primary" className={classes.noElevation}>
        <Toolbar component={Container} maxWidth={false} justify="space-between">
          ...
          <nav className={classes.mainNav}>
            <IconButton aria-label="GitHub repository" color="inherit" className={classes.navButton} component="a" href="https://github.com/EYLatamSouth/beyondstyle">
              <SvgIcon color="inherit">
                <path d="M12,0.3C5.4,0.3,0,5.6,0,12.2c0,5.2,3.3,9.8,8.2,11.4C8.8,23.7,9,23.3,9,23v-2c-3.3,0.7-4-1.6-4-1.6
            ...
            <IconButton aria-label="npm package" color="inherit" className={classes.navButton} component="a" href="https://www.npmjs.com/package/beyondstyle">
              <SvgIcon color="inherit">
